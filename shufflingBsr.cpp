...
ShufflingBsr::ShufflingBsr() : IntersectionAlg(){
    
}

int ShufflingBsr::intersect(int* arrayA, int sizeA, int* arrayB, int sizeB, int* arrayResult){
    ...
    card_c = this->intersect_shuffle_bsr_b4(bases_a, states_a, card_a, bases_b, states_b, card_b, bases_c, states_c);
    int size_c = 0;
