...
Shuffling::Shuffling() : IntersectionAlg(){
    
}

int Shuffling::intersect(int* arrayA, int sizeA, int* arrayB, int sizeB, int* arrayResult){
    return this->intersect_shuffle_uint_b4(arrayA, sizeA, arrayB, sizeB, arrayResult);
}

std::string Shuffling::getName(){
    return "Shuffling";
}

int Shuffling::intersect_shuffle_uint_b4(int *set_a, int size_a,
